...
{   
    /**
     * 房源搜索
     * @desc GET 房源搜索 ( <a href="/help?house-search-filters" target="_blank">Filters</a> <a href="/help?house-search-results" target="_blank">Results</a> )
     * @param string $type 售房:purchase, 租房: lease, 默认为售房
     * @param string $q 搜索关键词(按中/英文城市名, zipcode, 房源号, 以及全文搜索)
     * @param [] $filters 筛选器，参照说明中的"Filters"
